...
class ObjDetCodegen:
    ...
    def code_gen(self):
        ...
        NNModel_hpp_file_path = os.path.join(self.project, 'src', 'Model', 'include', 'YOLOv8nODModel.hpp')
        ...
        NNModel_cpp_file_path = os.path.join(self.project, 'src', 'Model', 'YOLOv8nODModel.cpp')
        ...
        PostProc_hpp_file_path = os.path.join(self.project, 'src', 'YOLOv8nODPostProcessing.hpp')
