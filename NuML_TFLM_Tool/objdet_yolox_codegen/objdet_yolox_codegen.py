...
class ObjDetYoloXCodegen:
    ...
    def code_gen(self):
        ...
        NNModel_hpp_file_path = os.path.join(self.project, 'src', 'Model', 'include', 'YoloXnanoNu.hpp')
        ...
        NNModel_cpp_file_path = os.path.join(self.project, 'src', 'Model', 'YoloXnanoNu.cpp')
